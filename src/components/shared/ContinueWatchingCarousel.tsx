                        ...
                        >
                            ...
                            >
                                ...
                                {item.progress !== undefined && item.progress > 0 && (
                                    <div className="absolute bottom-0 left-0 right-0 h-1 md:h-1.5 bg-gray-700 z-10">
                                        <div
                                ...
                                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center z-10">
                                    ...
                                    >
                                        <Play className="w-12 h-12 md:w-16 md:h-16 text-white group-hover/play:text-purple-400 fill-current mb-2 transition-colors" />
                                    </button>
