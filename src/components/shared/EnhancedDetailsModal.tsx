                    ...
                    <>
                        ...
                        <div className="relative w-full" style={{ aspectRatio: '16/9' }}>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6">
                                <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-white drop-shadow-2xl mb-2 md:mb-3">
                                    {cleanTitle}
                                </h2>

                                {/* Metadata Row */}
                                <div className="flex flex-wrap items-center gap-2 md:gap-3 text-gray-200 text-xs md:text-sm">
                                    {year && (
                                    ...
                                    {genres && (
                                        <div className="flex items-center gap-1">
                                            <span className="px-2 py-0.5 bg-white/20 rounded-md text-[10px] md:text-xs font-medium">
                                                {genres}
                                            </span>
                                        </div>
                                    )}
